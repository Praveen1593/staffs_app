...
ClassTestCLSModel classTestPastModelFromJson(String str) => ClassTestCLSModel.fromJson(json.decode(str));

String classTestPastModelToJson(ClassTestCLSModel data) => json.encode(data.toJson());

class ClassTestCLSModel {
  ClassTestCLSModel({
    required this.data,
    required this.links,
    required this.meta,
  ...
  factory ClassTestCLSModel.fromJson(Map<String, dynamic> json) => ClassTestCLSModel(
