...
import 'classtest_attachements_screen1.dart';

class ClasstestSubmissionScreen1 extends StatelessWidget {
  final Subject subjectList;

  const ClasstestSubmissionScreen1({Key? key, required this.subjectList})
      : super(key: key);
              ...
              children: [
                ...
                Wrap(
                  children: [
                    InkWell(
                      onTap: (){
                        Get.to(ClassTestAttachmentScreen1());
                      },
                      child: Container(
                        height: 50,
                        width: 50,
                ...
                InkWell(
                  onTap: ()async{
                    if (controller.homeworkController.text.isNotEmpty) {
                      ...
                      Get.snackbar("Failure", "", snackPosition: SnackPosition.BOTTOM, duration: Duration(seconds: 10), backgroundColor: AppColors.blackColor, colorText: AppColors.lightOrange);
