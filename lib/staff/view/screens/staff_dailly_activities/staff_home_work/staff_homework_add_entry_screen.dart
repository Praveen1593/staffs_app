...
class StaffAddEntryHomework extends StatelessWidget {
  int? type;
  int? hwId;
  ...
  TextFormField _textFormField(
      StaffClassTeacherHomeworkController controller,
                          ...
                          child: InkWell(
                            onTap: () async{
                              Map<String,dynamic> mapData = {
                                ...
                                "homework_image_id":controller.attachmentList?[index].id,
                              };
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              ...
                              await controller.sendHomeworkSubmission(
                                  ...
                                  url:
                                      "${ApiHelper.todayHomeworkSubmitUrl}$hwId");
