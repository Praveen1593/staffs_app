...
import 'package:flutter_projects/staff/view/screens/staff_dailly_activities/staff_home_work/staff_homework_reply_staff_entry_screen.dart';
import 'package:get/get.dart';
import '../../../../../common/widgets/common_widgets.dart';
import '../../../../controller/daily_activities/homework_controller/homework_controller.dart';

class StaffReplyStaffHomework extends StatelessWidget {
  int? hwId;

  StaffReplyStaffHomework({this.hwId});
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        for (int i = 0;
                                            i <
                                                controller
                                                    .studentReplyList!.length;
                                            i++) {
                                          controller.staffReplyEntryList1.add(
                                              controller.studentReplyList?[i]
                                                      .id ??
                                                  0);
                                        }
                                      },
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: controller.currentIndex != 2
                                ? controller.multiReplySelect == true ||
                                    ...
                                    : InkWell(
                                        onTap: () {
                                          controller.staffReplyEditController
                                              .text = controller
                                                  .studentReplyList?[index]
                                                  .staffReply
                                                  ?.staffDescription ??
                                              "";
                                          Get.to(StaffReplyStaffEntryHomework(
                                            hwId: hwId,
