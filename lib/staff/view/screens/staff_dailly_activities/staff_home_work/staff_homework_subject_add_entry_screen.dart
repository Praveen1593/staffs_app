...
class SubjectStaffAddEntryHomework extends StatelessWidget {
  int? type;
  int? hwId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<StaffHomeworkController>(
            ...
            builder: (staffHomeworkController) {
              return staffHomeworkController.basicSettingsmodel?.code == 200
                  ? buildBody(staffHomeworkController, context)
                  : SizedBox(
      ...
      children: [
        Padding(
          ...
          child:
            ...
            controller.basicSettingsmodel?.data?.staffHomeworkApprovalType ==
                        1 ||
                        ...
                        Row(
                          children: [
                            controller.attachmentList?[index].oldAttachFile !=
                                        null &&
                                    controller
                                        .attachmentList![index].oldAttachFile!
                                        .contains(".pdf")
                                ? const SMSImageAsset(
                          ...
                          child: InkWell(
                            onTap: () async {
                              Map<String, dynamic> mapData = {
                                "homework_id": hwItemId,
                                "homework_image_id":
                                    controller.attachmentList?[index].id,
                              };
                              int result =
                                  await controller.imageDelete(mapData);
                              if (result == 200) {
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              ...
                              await controller.sendHomeworkSubmission(
                                  ...
                                  staffHomeworkApprovalType: controller
                                      .basicSettingsmodel!
                                      .data!
                                      .staffHomeworkApprovalType!,
                                  filesList: controller.filesList,
                                  url:
                                      "https://test.schoolec.in/api/staff/v2/homework/today-homework-submit/$hwId");
                            },
...
class StaffHomeworkAttachment {
  File? file;
  String fileName;

  StaffHomeworkAttachment({required this.file, required this.fileName});
}
