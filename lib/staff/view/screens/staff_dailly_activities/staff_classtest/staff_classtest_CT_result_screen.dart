...
class StaffCTResultClasstest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<StaffClassTeacherClasstestController>(
  ...
  Widget buildBody(StaffClassTeacherClasstestController controller, BuildContext context) {
    return Column(
      children: [
        Card(
