...
class StaffAddEntryClasstest extends StatelessWidget {
  ...
  Widget buildBody(
      StaffClasstestController controller, BuildContext context) {
    return Column(
      children: [
        Padding(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () async{
                          ...
                          print("class_test_id : $classTestId");
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              ...
                              await controller.sendClassTestSubmission(
                                  ...
                                  classTestApprovalType: controller.basicSettingsModel!.data!.staffHomeworkApprovalType!,
                                  filesList: controller.filesList,
                                  url: "https://test.schoolec.in/api/staff/v2/class-test/today-class-test-submit/$classTestId?date=${controller.selectedDate}");
...
class StaffClassTestAttachment {
  File? file;
  String fileName;

  StaffClassTestAttachment({required this.file, required this.fileName});
}
